    ...
    <main className="max-w-[400px] mx-auto px-4 py-8">
      ...
      {!user && (
        <p className="text-gray-400 text-sm mb-6">
          <span style={{ fontSize: '24px' }}>Simple status messaging app.</span><br /><span style={{ fontSize: '14px' }}>No photos, no videos, no links,<br />and messages delete 24 hours after post.</span>
        </p>
      )}
